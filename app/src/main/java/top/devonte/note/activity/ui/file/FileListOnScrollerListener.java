...
public class FileListOnScrollerListener implements AbsListView.OnScrollListener {
    ...
    public FileListOnScrollerListener(InfinityList fileList, FileListAdapter fileListAdapter) {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if (!loading && scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE
            ...
            fileList.loading();
            loading = true;
            FileModel.getInstance().getFiles(page, new BaseCallBack(fileList.getContext()) {
